...
import com.ljs.actor.dialog.ForResActors;
import com.ljs.actor.dialog.ForShopActors;
import com.ljs.res.Res;
import com.ljs.stage.base.BaseStage;

public class ResPurchaseStage extends BaseStage {
    private ForResActors forResActors;
    private Image bgImg;
    /**TEXT*/
    private Label label;
    private Label line1;
    ...
    public ResPurchaseStage(MainGame mainGame, Viewport viewport){
    ...
    private void init(){
        ...
        forResActors = new ForResActors(getMainGame());
        forResActors.setPosition(0,0);
        addActor(forResActors);
        /**TEXT*/
    ...
    public void whichitem(Integer num){
        ...
        forResActors.changeRes(num);
    }
    public void whichprice(Integer price){
        this.price = price;
        line1.setText("您将消耗"+price+"金币");
        forResActors.changePrice(price);
    }

    public void changeBtn(Integer btn){
        forResActors.changeBtn(btn);
    }

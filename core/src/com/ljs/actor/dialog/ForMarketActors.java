...
public class ForMarketActors extends BaseGroup {  /**确定按钮*/
    ...
    public ForMarketActors(MainGame mainGame){
        super(mainGame);
        init();
    }
    ...
    private void init(){
        ...
        confirmBtn.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                /**搜寻可用鱼塘space*/
                /**读取C科技*/
                Preferences prefs = Gdx.app.getPreferences(Res.GameData.USER_CTECH_FILENAME);

...
public class ForShopActors extends BaseGroup {
    /**确定按钮*/
    ...
    public ForShopActors(MainGame mainGame){
        super(mainGame);
        init();
    }
    ...
    private void init(){
        ...
        xBtn.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                 ...
                 *
                 * */
                getMainGame().getGameScreen().setShowConfirmPurchaseStage(false,num);
        ...
        confirmBtn.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                if(Res.GameData.FISH_CHILD_PRICE[num]>goldss){
                    //金额不足
                    getMainGame().getGameScreen().getConfirmPurchaseStage().changeText(2);
                    ...
                    if(reach >= max){
                        //池塘满了
                        getMainGame().getGameScreen().getConfirmPurchaseStage().changeText(3);
